...
public class MainFrm extends JFrame {
	...
	public MainFrm() {
		...
		menuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ShopMemberUpdatePhoneInterFrm shopMemberUpdatePhoneInterFrm = new ShopMemberUpdatePhoneInterFrm();
				shopMemberUpdatePhoneInterFrm.setVisible(true);
				table.add(shopMemberUpdatePhoneInterFrm);
				}
		});
